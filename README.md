...
- 🖼️ **Icons:** gespeicherte Icons mit **Vorschau** ansehen und **auf der Uhr anzeigen**,
  **LaMetric-Galerie direkt in der App durchsuchen** und per Tipp auf die Uhr laden
  (PNG wird automatisch zu GIF gewandelt), Speicherbelegung
